...
if __name__ == '__main__':
    ...
    send_zmq_msg("manipulateObject;cam2;translate;0.0,-10.0,5.5")
    send_zmq_msg("manipulateObject;cam2;spin;-90.0,0.0,0.0")
    ...
    send_zmq_msg("render")
    send_zmq_msg("manipulateObject;sphere1;translate;0.0,0.1,0.0")
